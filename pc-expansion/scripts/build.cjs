...
async function main(){
 ...
 const report={title:'ARENA — Filhos da Areia · Terras Selvagens',sourceProject:'99acc7d3-ea06-4526-be68-86475e56cd5b',sourceVersion:1789690036364,edition:'Illustrated 4.0 + Expansion 5.0 stage 4',expansionVersion:'5.0.0-alpha.4',expansionStage:4,assets:assetReport,htmlBytes:Buffer.byteLength(html),htmlSha256:crypto.createHash('sha256').update(html).digest('hex'),jsBytes:Buffer.byteLength(code),cssBytes:Buffer.byteLength(css),networkRequired:false,fontsBundled:false};
